...
public class NursingInstitutionController {
    ...
    public ResponseEntity<NursingInstitutionSearchResponse> searchNursingInstitution( @RequestParam(required = false) String nursingInstitutionName){
        NursingInstitutionSearchResponse response = nursingInstitutionService.searchNursingInstitutionByName(nursingInstitutionName);
