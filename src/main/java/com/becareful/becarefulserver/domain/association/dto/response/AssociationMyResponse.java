...
public record AssociationMyResponse(String associationName, Integer associationMemberCount) {

    public static AssociationMyResponse from(Association association, Integer associationMemberCount) {
        return new AssociationMyResponse(association.getName(), associationMemberCount);
    }
}
