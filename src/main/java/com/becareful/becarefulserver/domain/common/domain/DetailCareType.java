...
public enum DetailCareType {
    스스로식사가능(식사보조, "스스로 식사 가능"),
    식사차려드리기(식사보조, "식사 차려드리기"),
    요리필요(식사보조, "죽, 반찬 등 요리 필요"),
    경관식보조(식사보조, "경관식 보조"),
    스스로거동가능(이동보조, "스스로 거동 가능"),
    이동시부축도움(이동보조, "이동시 부축 도움"),
    휠체어(이동보조, "휠체어 이동 보조"),
    거동불가(이동보조, "거동 불가"),
    스스로배변가능(배변보조, "스스로 배변 가능"),
    가끔실수(배변보조, "가끔 대소변 실수시 도움"),
