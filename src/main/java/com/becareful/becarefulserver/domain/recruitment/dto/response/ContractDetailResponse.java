...
public record ContractDetailResponse (
        ...
        public static ContractDetailResponse from(Elderly elderly, List<DayOfWeek> workDays,
                                                  LocalTime workStartTime, LocalTime workEndTime,
                                                  Integer workSalaryAmount, LocalDate workStartDate) {
                ...
                return new ContractDetailResponse(workDays, workStartTime, workEndTime,
                        workSalaryAmount, workStartDate, careInfoList);
        }
}
