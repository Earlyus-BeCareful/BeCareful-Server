...
public record CareerDetailResponse(String workInstitution, String workYear) {

    public static CareerDetailResponse from(CareerDetail careerDetail) {
        return new CareerDetailResponse(careerDetail.getWorkInstitution(), careerDetail.getWorkYear());
    }
}
